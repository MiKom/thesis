...
This section will describe OpenCL objects that mange execution of programs on the
...
processor and the other one isthe other one is  NVIDIA GTX580 -- a high--end consumer GPU. High--level hardware
