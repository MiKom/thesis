...
vertices. \todo{Check article} The combination of these singns is called the
...
\begin{figure}
	...
	\label{fig:mccompact}
\end{figure}
\todo{replace figures \ref{fig:mccompact} and \ref{fig:mcvertscan} with proper graphics}
