\documentclass[twoside,openright,a4paper]{memoir}
...
\include{previouswork/previouswork}
\include{karstification/karstification}
\include{opencl/opencl}
\include{marchingcubes/marchingcubes}
